...
function list(path) {
  ...
  <div class="card">
   <div id="readme_md" style="display; padding: 20px 20px;">
	<h1>DriveQ</h1>
	<ul>
	<li>Use Folder named <b>Ram</b> Only!!!</li>
	<li>Because Main files are Stored their</li>
	<li>Other than <b>Ram</b> all other Folders are of Temporary usage for Server</li>
	</ul>
	<h2>How to Use</h2>
	<ul>
	<li>You can now watch online or Download the files</li>
	<li>Some times Vidoes/Subtitles/Captions might not not work..... Try after some time</li>
	<li>Some times Vidoes/Files won't Download(throws error)........ Try after some time</li>
	</ul>
  </div>
  </div>
  </div>
